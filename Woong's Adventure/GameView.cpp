...
namespace adventure 
{
	...
	void GameView::Story()
	{
		...
		gotoXY(8, 7);
		cout << "간혹 곰과 고블린와 같이 조금 강한 몬스터가 있긴 하지만, 그 개체 수는 슬라임에 비해 현저히 적기도 하고";
		gotoXY(8, 8);
	...
	void GameView::Explain()
	{
		...
		gotoXY(8, 8);
		cout << "무려 4업을 하고, 포악한 곰을 잡는다면 7레벨, 고블린를 잡는다면 9레벨이 상승합니다.";
		gotoXY(8, 9);
		...
		cout << "신중하게 가시길 바랍니다.";
		gotoXY(8, 15);
		cout << "몬스터 또는 용과 전투를 벌이다 죽는다면 레벨이 5만큼 감소합니다.";
		gotoXY(8, 16);
		cout << "3회 공격 후 다음 공격은 스킬을 사용합니다. 스킬은 각 직업별로 다르며, 초보자 또한 스킬이 있습니다.";
		gotoXY(8, 17);
